"""
Clean document processor implementing the new architecture interfaces.
Separates processing, persistence, and indexing concerns.
"""
...
from core.interfaces.document_processing import (
    ProcessedDocument, ProcessingResult, DocumentProcessor,
...
class CleanDocumentProcessor(DocumentProcessor):
